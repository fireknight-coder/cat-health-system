...
const reportSchema = new mongoose.Schema({
  ...
  aiSuggestion: { type: String, enum: ['new', 'existing'], default: 'new' },
  aiSuggestionConfidence: { type: Number, min: 0, max: 1 },
  aiRefreshCount: { type: Number, default: 0 },
  aiLastRefreshedAt: Date,
  // 审核相关
  status: { 
    type: String, 
